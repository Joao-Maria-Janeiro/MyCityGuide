...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        profileImg = (CircleImageView) findViewById(R.id.register_image_btn);
    ...
    //Neste momento não é utilizada, mas pode servir para fazer o controlo de se o user quer fazer upload ou não da imagem
